...
pub extern fn vfprintf(__s: [*c]FILE, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_26) c_int;
pub extern fn vprintf(__format: [*c]const u8, __arg: [*c]struct___va_list_tag_26) c_int;
pub extern fn vsprintf(__s: [*c]u8, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_26) c_int;
pub extern fn snprintf(__s: [*c]u8, __maxlen: c_ulong, __format: [*c]const u8, ...) c_int;
pub extern fn vsnprintf(__s: [*c]u8, __maxlen: c_ulong, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_26) c_int;
...
pub const Fraction = extern struct {
    num: u32 = 0,
    denom: u32 = 0, // spooky default
};
pub const DictItem = extern struct {
    key: [*:0]const u8 = null,
    value: [*:0]const u8 = null,

    pub fn compare(self: DictItem, other: DictItem) std.math.Order {
        return std.mem.orderZ(self.key, other.key);
    }

    pub fn lessThan(_: anytype, lhs: DictItem, rhs: DictItem) bool {
        return lhs < rhs;
    }
};
pub const Dict = extern struct {
    flags: u32 = 0,
    n_items: u32 = 0,
    items: [*]const DictItem = null,

    pub fn sort(self: *Dict) void {
        if (self.n_items > 0) {
            const items = self.items[0..self.n_items];
            std.mem.sort(DictItem, items, self, DictItem.lessThan);
        }
        // if (dict->n_items > 0)
...
// /home/bhetz/.local/lib/zig/include/__stddef_offsetof.h:16:9
...
// ./spa/utils/defs.h:274:9
pub inline fn SPA_PTR_ALIGNMENT(p: anytype, @"align": anytype) @TypeOf(@import("std").zig.c_translation.cast(isize, p) & (@"align" - @as(c_int, 1))) {
    _ = &p;
    _ = &@"align";
    return @import("std").zig.c_translation.cast(isize, p) & (@"align" - @as(c_int, 1));
}
